...
**Always consider consulting a licensed financial advisor or other qualified professional for guidance specific to your situation.**
...
Calculator outputs depend entirely on the inputs and assumptions shown on each tool page. They are planning aids, not guarantees. Future returns, especially investment returns, are inherently uncertain; no calculator can predict them.

## Affiliate and advertising disclosure

Money Clarity may display advertising (for example, Google AdSense) and may, in the future, include affiliate links. If affiliate links are ever added, this disclosure will be updated, and any page containing them will state so clearly. Affiliate links do not change the price you pay.

## Limitation of liability

To the fullest extent permitted by law, the site and its author accept no liability for any loss or damage arising from the use of, or reliance on, any content or tool on this site.

## Contact

Questions about this disclaimer: see the [contact page](contact.html).
