---
title: "Expense Ratio Calculator â€â€— What an Annual Fee Really Costs"
...
High fees are only worth paying if the fund reliably delivers higher *net* returns â€â€— and reliably beating the market after fees is rare and hard to predict. See [index funds vs mutual funds](index-funds-vs-mutual-funds.html) for how these categories actually relate.
...
3. **Let the investment period do its work** â€â€— the fee penalty grows with time, which is why long-horizon investors care most.
