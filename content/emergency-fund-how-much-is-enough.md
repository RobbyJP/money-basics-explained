...
A common mistake is using one pot for everything. An emergency fund handles *unknown* shocks; a sinking fund handles *predictable* expenses you can see coming — a new laptop next year, annual insurance premiums, a wedding. Keeping them separate makes both easier to reason about: see the [sinking fund vs emergency fund](../index.html) comparison.
...
- [Sinking fund vs emergency fund](../index.html) — separating shocks from planned spending
- [Debt payoff calculator](debt-payoff.html) — an emergency fund protects you from creating debt when things go wrong
- [The 50/30/20 budget rule](../index.html) — where the savings for this fund fits in a budget
