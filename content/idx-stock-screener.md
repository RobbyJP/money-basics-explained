...
- **Min market cap** — keep this above Rp 10 trillion for liquidity; smaller caps are riskier and harder to exit.
- **Min ROE** — raise to 20 to isolate the most profitable names.
- **Max P/BV** — lower to 1.5 to hunt value; most quality stocks will fall out.
- **Min growth** — 5–10% keeps the list to growers; set to 0 or below to include turnaround names.
- **Min yield** — 3%+ selects dividend payers; 0 keeps everyone.
- **Max D/E** — 1 keeps the conservative list; banks only appear at higher values.
...
- **Banks are largely invisible.** Because of the leverage filter, financials rarely appear — yet banks are Indonesia's most profitable sector. If you want to screen banks, raise the D/E maximum; the other metrics still rank them.
- **Data has an as-of date.** Fundamentals come from audited annual reports (2022–2025) and prices from the latest market close — the "data as of" line in the screener shows exactly when. Between reporting seasons, numbers age.
...
- [How compound interest works](compound-interest.html) — why long-term holding matters more than any single pick
- [Index funds vs mutual funds](../index.html) — the low-effort alternative to picking individual stocks
- [Emergency fund calculator](emergency-fund.html) — build the buffer that lets you hold through drawdowns
