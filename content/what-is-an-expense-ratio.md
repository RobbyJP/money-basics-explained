...
High fees are only worth paying if the fund reliably delivers higher *net* returns — and reliably beating the market after fees is rare and hard to predict. See [index funds vs mutual funds](../index.html) for how these categories actually relate.
...
4. The difference compounds alongside your returns: see the [compound interest calculator](compound-interest.html) for the return side of the same math, and the [DCA calculator](dollar-cost-averaging.html) for how regular contributions interact with it.
