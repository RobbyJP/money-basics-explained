...
3. **The compounding itself** — interest on interest, which is where most of the growth comes from at longer periods.
...
1. **Initial investment** — what you already have invested (leave at 0 if you are starting from nothing).
2. **Monthly contribution** — the regular amount you plan to add.
3. **Annual return (%)** — a conservative long-run estimate. Try 5–7% for broad index funds and compare the difference.
4. **Years** — your horizon. The tool accepts partial years.
5. **Compounding frequency** — monthly matches how most products accrue; switching to annual shows how much frequency matters.
...
- **Ignoring fees and taxes.** A 1% annual fee on a 7% return costs you roughly a third of the final balance over 20 years — see the [expense ratio calculator](expense-ratio.html).
...
- [Compound interest vs simple interest](../index.html) — why compounding is the whole game
- [The worked example behind the calculator](compound-interest.html) — how compounding built on itself in one real scenario
- [Savings goal planner](goal-planner.html) — reverse-engineer the monthly amount you need for a target
- [DCA calculator](dollar-cost-averaging.html) — how regular contributions behave during market swings
