...
- [Emergency fund calculator](emergency-fund.html) — build a buffer so unexpected costs don't create new debt
- [Sinking fund vs emergency fund](../index.html) — the difference between saving for shocks and saving for planned expenses
- [Compound interest calculator](compound-interest.html) — what the same monthly amount could do on the investment side
