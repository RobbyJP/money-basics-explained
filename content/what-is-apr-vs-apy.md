...
4. For long-term investing, the same compounding math powers your returns: see the [compound interest calculator](compound-interest.html) and the [expense ratio calculator](expense-ratio.html) for what eats into that compounding.
